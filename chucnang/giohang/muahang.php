...
if (isset($_POST['submit'])) {
    ...
    if (isset($ten) && isset($email) && isset($sdt) && isset($diachi)) {
        ...
        $mailer->setFrom('yourmail@gmail.com', 'HTNK Mobile'); // mail và tên người gửi 
        ...
        $mailer->AddCC("yourmail@gmail.com", "HTNK Mobile");

        $mailer->Subject = 'Hóa đơn xác nhận mua hàng từ HTNK Mobile'; // title mail
