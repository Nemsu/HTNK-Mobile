        ...
        <div id="banner">
            <div class="row">
                <div id="logo" class="col-md-4 col-sm-12 col-xs-12">
                    <h1>
                        <a href="index.php">
                            <img src="./images/logo.png" alt="HTNK mobile">
                        </a>
                    </h1>
                </div>
                ...
                <div id="footer-main" class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row footer-wide">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <ul class="footer__list">
                                <li class="footer__item">
                                    <a href="index.php?page_layout=gioithieu" class="footer__item__link underline">Giới Thiệu Về HTNK Mobile</a>
                                </li>
                                <li class="footer__item">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <ul class="footer__list">
                                <li class="footer__item">
                                    <a href="https://www.facebook.com/neimsu/" target="_blank" class="footer__item__link underline">
                                        <i class="fab fa-facebook"></i>
                                        Facebook</a>
                                </li>
                                <li class="footer__item">
                                    <a href="" target="_blank" class="footer__item__link underline">
                    ...
                    <h4>HTNK mobile điện thoại cao cấp chính hãng</h4>
                    <img src="./images/copyright.png" class="footer__coppyright-img" alt="đã đăng kí bộ công thương">

                    <p><b>Địa chỉ:</b> 390 Hoàng Văn Thụ, Phường 4, Tân Bình, Thành phố Hồ Chí Minh | <b>Hotline:</b> 0393 744 165</p>
                    <h3 class="footer__copyright-text">© Powered by
                        <span>LTTC</span>                         
                        <script>
